...
impl JarrowRudd {
    ...
    pub fn ivol(
        ...
        solve_ivol(
            p,
            |v| JarrowRudd::greeks(is_european, is_call, S, K, t, r, b, v, n).price,
            max_iterations,
            epsilon,
        )
    }
    ...
    pub fn fdm_greeks(is_european: bool, is_call: bool, n: usize) -> FdmWithCarry {
        ...
        FdmWithCarry::new(move |S: f64, K: f64, t: f64, r: f64, b: f64, v: f64| {
            JarrowRudd::greeks(is_european, is_call, S, K, t, r, b, v, n).price
        })
    }
}
...
mod tests {
    ...
    fn it_should_calc_price() {
        ...
        for (is_european, is_call, S, K, r, q, t, v, expected, threshold) in [
            ...
            let b = r - q;
            let value = JarrowRudd::greeks(is_european, is_call, S, K, t, r, b, v, 200).price;
